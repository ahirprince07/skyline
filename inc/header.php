                    ...
                    if(isset($_SESSION['login']) && $_SESSION['login']==true)
                    {
                        ...
                        echo<<<data
                            <div class="btn-group">
                                ...
                                <img src="$path$_SESSION[uPic]" class="me-1" style="width: 30px; height: 30px; object-fit: cover;">
                                $_SESSION[uName]
                                </button>
                ...
                <form id="login-form">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="txt" name="email_mob" class="form-control shadow-none" required>
                        </div>
                        <div class="mb-4">
            ...
            <div class="modal-content">
                <form id="forgot-form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-4">
                            <label class="form-label">Email</label>
                            <input type="txt" name="email" class="form-control shadow-none" required>
                        </div>
