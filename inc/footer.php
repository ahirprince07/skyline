    ...
    <h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by Baraiya Anuj and Bheda Prince</h6>
    ...
    <script>
        ...
        register_form.addEventListener('submit', (e)=>{
            ...
            xhr.onload = function(){
                if(this.responseText == 'pass_mismatch'){
                    ...
                    alert('error','Confirmation email sending failed!');
                }
        ...
        login_form.addEventListener('submit', (e)=>{
            ...
            xhr.onload = function(){
                if(this.responseText == 'inv_email_mob'){
                    ...
                    alert('error','Email not verified! Please verify your email first.');
                }
                else if(this.responseText == 'inactive'){
                    alert('error','Account inactive! Please contact admin.');
                }
                else if(this.responseText == 'invalid_pass'){     
                    alert('error','Invalid password!');
                }
                else if(this.responseText == 'login_failed'){    
                    alert('error','Login failed! Server down!'); 
                }
                else{
        ...
        forgot_form.addEventListener('submit', (e)=>{
            ...
            xhr.onload = function(){
                ...
                else if(this.responseText == 'reset_failed'){    
                    alert('error','Password reset failed! Server down!'); 
                }
                else{
                    alert('success','Temporary password sent to your email. Please check your inbox.');
                    forgot_form.reset();
                } 
            }
            xhr.send(data);
        ...
        function checkLogininToBook(status,room_id)
        {
            if(status){
